...
def image_processing_test_examples():
    ...
    chroma1_white_dsc20_img = IP.chroma_key(dsc20_img, bg_img, (255, 205, 210))
    img_save("img/out/dsc20_chroma1_white.png", chroma1_white_dsc20_img)

    rotate_dsc20_img = IP.rotate_180(dsc20_img)
    img_save("img/out/dsc20_rotate.png", rotate_dsc20_img)

    crop1_dsc20_img = IP.crop(dsc20_img, 50, 75, (75, 50))
    img_save("img/out/dsc20_crop1.png", crop1_dsc20_img)

    crop2_dsc20_img = IP.crop(dsc20_img, 100, 50, (100, 150))
    img_save("img/out/dsc20_crop2.png", crop2_dsc20_img)

    tint_dsc20_img = IP.tint(dsc20_img,color=(0,0,100))
    img_save("img/out/dsc20_tint.png", tint_dsc20_img)

    clear_channel1_dsc20_img = IP.clear_channel(dsc20_img,0)
    img_save("img/out/dsc20_clear_channel1.png", clear_channel1_dsc20_img)

    beeop = IP.clear_channel(dsc20_img,2)
    img_save("img/out/dsc20_clear_channel2.png", clear_channel2_dsc20_img)
